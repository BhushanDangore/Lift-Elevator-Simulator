...
var navbtnl1 = document.getElementById("div1");
var navbtnl2 = document.getElementById("div2");
var navbtnl3 = document.getElementById("div3");
...
function myfunction() {
    if (bool == 0) {
        ...
        bool = 1;
        navbtnl1.style.cssText = "transform-origin: 30%; transform: rotate(45deg); background-color: rgba(210, 0, 0, 0.800);";
        navbtnl2.style.cssText = "background-color: rgba(0, 0, 0, 0);";
        navbtnl3.style.cssText = "transform-origin: 30%; transform: rotate(-45deg); background-color: rgba(210, 0, 0, 0.800);";
        table.style.cssText = "visibility: visible; opacity: 1;";
    }
    else if (bool == 1) {
        nav.style.width = "5vw";
        bool = 0;
        navbtnl1.style.cssText = "transform-origin: 30%; transform: rotate(0deg); background-color: rgb(136, 136, 136);";
        navbtnl2.style.cssText = "background-color: rgb(136, 136, 136);";
        navbtnl3.style.cssText = "transform-origin: 30%; transform: rotate(0deg); background-color: rgb(136, 136, 136);";
        table.style.cssText = "visibility: hidden; opacity: 0;";
    }
}
